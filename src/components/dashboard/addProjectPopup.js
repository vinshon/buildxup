...
hover:file:bg-blue-100"
                ...
                <div className=" border-t py-6 px-8 space-x-4 flex items-center justify-end  ">
                  <button onClick={()=> setOpen(false)} className=" border border-primary bg-white px-4 py-2 rounded-md font-medium  text-primary">
                    Cancel
                  </button>
                  <button onClick={()=> setOpen(false)}  className="bg-primary border border-primary  px-4 py-2 rounded-md font-medium text-white \">
                    Submit
                  </button>
                </div>
              </div> 
